...
<div class="row">
    ...
    <div class="row mt-3 mb-5">
        ...
        <div class="col-md-3">
            <div class="form-group mb-5">
                {{ Form::label('adhar', __('messages.user.adhar').':', ['class' => 'form-label']) }}
                {{ Form::text('adhar', $patient->user->adhar ?? null, ['class' => 'form-control', 'maxlength' => '12','minlength' => '12']) }}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group mb-5">
                {{ Form::label('mediclaim', __('messages.user.mediclaim').':', ['class' => 'form-label']) }}
                {{ Form::text('mediclaim', $patient->user->mediclaim ?? null, ['class' => 'form-control', 'maxlength' => '12','minlength' => '12']) }}
            </div>
        </div>
    </div>
