...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('invoices*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('invoices*') ? 'active' : '' }}" href="{{ route('invoices.index') }}"> {{ __('messages.invoices') }} </a>
</li>
@endmodule
@module('Bills',$modules)
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('invoices*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 {{ Request::is('bills*') ? 'active' : '' }}" href="{{ route('bills.index') }}"> {{ __('messages.bills') }} </a>
</li>
@endmodule
@endrole
