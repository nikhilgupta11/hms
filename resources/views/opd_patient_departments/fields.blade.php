...
<div class="row gx-10 mb-5">
    ...
    <div class="mb-5">
        <div class="mb-5">
            {{ Form::label('case_id', __('messages.ipd_patient.case_id').':', ['class' => 'form-label']) }}
            <span class="required"></span>
            {{ Form::text('case_id', null, ['class' => 'form-control', 'hidden', 'id' => 'opdCaseId', 'placeholder' => 'Enter Case ID']) }}
             <!--{{ Form::number('case_id', (isset($data['case_id'])) ? $data['case_id']->case_id : 0, ['class' => 'form-control', 'max' => '20000000', 'step' => '.01']) }}-->
        </div>
    </div>
</div>
...
<!--        <div class="mb-5">-->
<!--            {{ Form::label('opd_number', __('messages.opd_patient.opd_number').':', ['class' => 'form-label']) }}-->
<!--            {{ Form::text('opd_number', rand(10000000, 99999999), ['class' => 'form-control', 'readonly', 'inputmode' => 'numeric', 'minlength' => '8', 'maxlength' => '8']) }}-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
<div class="col-md-2">
    <div class="mb-5">
        <div class="mb-5">
            {{ Form::label('opd_number', __('messages.opd_patient.opd_number').':', ['class' => 'form-label']) }}
            {{ Form::text('opd_number', null, ['class' => 'form-control', 'inputmode' => 'numeric', 'minlength' => '1', 'maxlength' => '8']) }}
        </div>
    </div>
</div>
