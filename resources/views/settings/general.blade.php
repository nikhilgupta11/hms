...
@section('section')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                <div class="form-group mb-5">
                    <lable>Print Name</lable>
                    <span class="required"></span>
                    <input type="text" name="print_name" class="form-control" value="{{$settings['print_name']}}">
                </div>
            </div>
            <!-- Company Name Field -->
            <div class="col-md-6">
                <div class="form-group mb-5">
                    <lable>Print Address</lable>
                    <span class="required"></span>
                    <input type="text" name="print_address" class="form-control" value="{{$settings['print_address']}}">
                </div>
            </div>
