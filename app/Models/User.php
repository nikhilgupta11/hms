...
class User extends Authenticatable implements HasMedia, MustVerifyEmail
{
    ...
    const INVOICE_FOR_RECEPTIONIST = 'INVOICE_FOR_RECEPTIONIST';
    
    const DOCUMENT_FOR_RECEPTIONIST = 'DOCUMENT_FOR_RECEPTIONIST';
    
    const MAIN_VACCINATION_MGT = 'MAIN_VACCINATION_MGT';
    
     const PRESCRIPTIONS_USER = 'PRESCRIPTIONS_USER';
    ...
    public static $rules = [
        ...
        'adhar' => 'nullable|integer|min:12',
        'mediclaim' => 'nullable|integer|min:12',
    ];
