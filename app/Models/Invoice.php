...
public static function generateUniqueInvoiceId()
{
    ...
    // Loop until a unique invoice ID is generated
    while (true) {
        // Generate a random 6-digit number and append it to the invoice ID
        $invoiceId .= rand(0, 9);
        if (strlen($invoiceId) === 6) {
            ...
            // If the invoice ID already exists, reset the invoiceId variable and generate a new one
            $invoiceId = '';
        }
    }
}
