...
//    }
    ...
    public function convertToPDF($id)
    {
        ...
        $pdf = PDF::loadView('prescriptions.prescription_pdf', compact('prescription', 'medicines', 'data', 'print_name','print_address','app_logo'))->setPaper('a4', 'portrait');;
        // $pdf = PDF::loadView('prescriptions.prescription_pdf', compact('prescription', 'medicines', 'data'));
        //return $pdf->download('example.pdf');

        return $pdf->stream($prescription['prescription']->patient->patientUser->full_name.'-'.$prescription['prescription']->id.".pdf");
    }
}
