...
Route::middleware('auth', 'verified', 'xss', 'checkUserStatus')->group(function () {
    ...
    Route::middleware('role:Lab Technician')->group(function () {
        ...
        Route::get('export-pathology-tests',
            ...
            // Route::get('/download-pdf/{id}', [pathologyTestExport::class, 'downloadPdf'])->name('downloadPdf');
    ...
    Route::middleware('role:Admin|Patient|Receptionist')->group(function () {
        Route::prefix('employee')->group(function () {
            ...
            Route::get('patient-admissions/{patient_admission}', [Employee\PatientAdmissionController::class, 'show'])->name('patient.patient-admissions.show')->where('patient_admission', '[0-9]+');
            Route::get('invoices', [Employee\InvoiceController::class, 'index'])->name('invoices');
            Route::get('invoices/{invoice}', [Employee\InvoiceController::class, 'show'])->name('patient.invoices.show')->where('invoice', '[0-9]+');
            ...
            Route::get('bills/{bill}', [Employee\BillController::class, 'show'])->name('employee.bills.show')->where('bill', '[0-9]+');
    ...
    Route::middleware('role:Admin|Doctor|Patient|Pharmacist')->group(function () {
        Route::resource('document-types', DocumentTypeController::class)->parameters(['document-types' => 'documentType']);
        Route::get('document-types', [DocumentTypeController::class, 'index'])->name('document-types.index')->middleware('modules');
        ...
        Route::get('operation-reports', [OperationReportController::class, 'index'])->name('operation-reports.index')->middleware('modules');
        ...
        Route::get('investigation-reports', [InvestigationReportController::class, 'index'])->name('investigation-reports.index')->middleware('modules');
    ...
    Route::middleware('role:Admin|Receptionist|Lab Technician|Pharmacist')->group(function () {
        ...
        Route::get('pathology-tests/get-standard-charge/{id}',
            ...
            [PathologyTestController::class, 'download'])->name('pdf.download');
